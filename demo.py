...
frame_save_dir = args.save_frame
...
def main_worker():
    ...
    for f in tqdm(range(0, video_length, neighbor_stride)):
        ...
        with torch.no_grad():
            ...
            save_image(masked_imgs[0], 'masked_imgs.png')
            mod_size_h = 60
            mod_size_w = 108
 ...
 # Saving videos
    ...
    writer = cv2.VideoWriter(save_path, cv2.VideoWriter_fourcc(*"mp4v"), args.savefps, (w, h))
    for f in range(len(comp_frames)):
        ...
        frame_path = os.path.join(frame_save_dir, f'{f:04d}.png')
