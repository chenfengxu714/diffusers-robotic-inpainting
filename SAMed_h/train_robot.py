...
from trainer_robot import trainer_robot
from icecream import ic

parser = argparse.ArgumentParser()
parser.add_argument('--root_path', type=str,
                    default='/rscratch/cfxu/diffusion-RL/style-transfer/mirage_sim_data/train_franka_finetune.json', help='root dir for data')
parser.add_argument('--output', type=str, default='./output/sam/results')
parser.add_argument('--dataset', type=str,
                    default='Robot', help='experiment_name')
parser.add_argument('--bg_dir', type=str,
                    default='/rscratch/cfxu/diffusion-RL/style-transfer/SAMed/datasets/finetune_bg_train.json', help='list dir')
...
parser.add_argument('--ckpt', type=str, default='/rscratch/cfxu/diffusion-RL/style-transfer/SAMed/SAMed_h/checkpoints/sam_vit_h_4b8939.pth',
