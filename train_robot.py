...
parser.add_argument('--root_path', type=str,
                    default='/rscratch/cfxu/diffusion-RL/style-transfer/rendering/train.json', help='root dir for data')
...
parser.add_argument('--bg_dir', type=str,
                    default='/rscratch/cfxu/diffusion-RL/style-transfer/SAMed/datasets/ign_train.json', help='list dir')
